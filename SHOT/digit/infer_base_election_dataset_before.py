...
if __name__ == "__main__":
    ...
    test_target = election.ElectionDatasetAll('../data/batch_inference.csv',
                transform=image_processing_no_effect)
    ...
    write_row_to_csv(f"../saved_result/before_adaptation/inference_base_election.csv", columns, [acc,precision,recall,f1,args.iteration])

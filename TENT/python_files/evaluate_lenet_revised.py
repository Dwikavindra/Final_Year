...
if __name__ == "__main__":
    ...
    model_paths = {
        'lenet5_batchNorm1': "/workspace/Dwika/fyp/model/save_model_batchNorm1.pt",
        'lenet5_batchNorm2': "/workspace/Dwika/fyp/model/save_model_batchNorm2.pt",
        'lenet5_batchNorm3': "/workspace/Dwika/fyp/model/save_model_batchNorm3.pt",
        'lenet5_batchNorm4': "/workspace/Dwika/fyp/model/save_model_batchNorm4.pt",
        'lenet5_batchNorm5': "/workspace/Dwika/fyp/model/save_model_batchNorm5.pt",
        'lenet5_batchNorm6': "/workspace/Dwika/fyp/model/save_model_batchNorm6.pt",
        'lenet5_batchNorm7': "/workspace/Dwika/fyp/model/save_model_batchNorm7.pt",
        'lenet5_batchNorm8': "/workspace/Dwika/fyp/model/save_model_batchNorm8.pt",
        'LeNet5_base': "/workspace/Dwika/fyp/save_model.pt"
    }
    
    dataset = CustomImageDataset('/workspace/Dwika/fyp/data_election/batch_inference.csv','', transform=clean_data.image_processing_sirekap_lenet)

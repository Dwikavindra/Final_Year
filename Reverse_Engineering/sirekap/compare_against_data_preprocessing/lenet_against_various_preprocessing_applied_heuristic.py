...
if __name__ == "__main__":
    ...
    parser.add_argument("--transform", type=str, required=True, help="The method for preprocessing to test choose ")
    ...
    sirekap_helper.write_row_to_csv(
        file_path=f"{args.result_path}/{args.transform}_base_applied_heuristic.csv",
